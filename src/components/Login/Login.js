                ...
                <div className="row">
                    <div className="col login-card">
                        <div className="text-center">
                            <h1 className="text-light fw-bold">PLEASE <span className="text-clr">LOGIN</span> ACCOUNT</h1>
                        ...
                        <div>
                            <Form onSubmit={signInEmailAndPass}>
                                ...
                                <button className="mb-3 w-50 login-btn" type="submit">
                                    Login
                                </button>
                            </Form>
                            <div>
                                <Link className="text-center text-decoration-none text-clr" to="/register"><p>Forgot your password? Please Sign up!</p></Link>
